                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($pageData['orderInfo'] as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $value['count_qty']; ?></td> <!--Изменить -->
                                </tr>
                            <?php } ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $pageData['orderInfo'][0]['branch']; ?></td>
                                <td><?php echo $pageData['orderInfo'][0]['email']; ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <h3>Покупатель:</h3>
                    <p>Логин: <strong><?php echo $pageData['orderInfo'][0]['login'] ?></strong></p>
                    <p>ФИО: <strong><?php echo $pageData['orderInfo'][0]['fullName'] ?></strong></p>
                    <p>Email: <strong><?php echo $pageData['orderInfo'][0]['email'] ?></strong></p>

                    <form method="POST" action="/cabinet/orders/checkOrder">
                        <input type="hidden" name="id" value="<?php echo $_GET['orderId']; ?>">
                        <button class="btn btn-success">Одобрить</button>
                    </form>
                    <br/>
                    <form method="POST" action="/cabinet/orders/deleteOrder">
                        <input type="hidden" name="id" value="<?php echo $_GET['orderId']; ?>">
